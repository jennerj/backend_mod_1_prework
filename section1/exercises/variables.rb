...
# Explain.
# I decided by looking at the question the variables were asking and determine that way. first_name will be a written answer which is best in a string. Second is asking a yes or no question so a boolean will be best here. 3rd is just asking for a number so I used an integer and hopefully you cant have half a pet so a floating point wont be necessary.
